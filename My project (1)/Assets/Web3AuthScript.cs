...
public class Web3AuthScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        var clientId = "BO74GpUIUetf2I62CGByLtLKRbSIMDSuZn1RhdEME8Y6zW0MjeeVGdq6cE0raA9Ohx1MjVr60Wvp1XKfCv8sVOw"; // Get your Web3Auth Client ID on https://dashboard.web3auth.io
        // IMP END - Dashboard Registration

        web3Auth.setOptions(new Web3AuthOptions()
        {
            clientId = clientId,
            redirectUrl = new System.Uri("https://drive.google.com/drive/folders/1qBPTmdApfAJwoYG_t7XdX5pLlDYuYwb_"),
    ...
    public void GrabEmailFromInputField()
    {
