...
public class SmartContract : MonoBehaviour
{
    ...
    private IEnumerator HandleAsyncCalls()
    {
        ...
        yield return StartCoroutine(GetTokensCoroutine("0x05b3DF12a3092828E727e9E15944Dcca01dCb367"));
        ...
        // StartCoroutine(CallGetItems("0x05b3DF12a3092828E727e9E15944Dcca01dCb367"));
    ...
    private IEnumerator GetTokensCoroutine(string personAddress)
    {
        ...
        {
            string tokens = tokensTask.Result;
            if (tokensText != null)
            {
