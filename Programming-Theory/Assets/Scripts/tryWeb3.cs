...
public class Web3AuthScript : MonoBehaviour
{
    ...
    Web3 web3;
    const string rpcURL = "https://rpc.ankr.com/multichain/37a1e410063b13f25438ca6df4dbf55b1bcc2008edbc9f95be8ef9f73d646a9f";
    ...
    public void Menu()
    {
        ...
        sc.CallGetTokens(publicAddress);
     
        sc.CallGetItems(publicAddress);

        getAccount();
        sc.playerPublicAddress = account.Address;
        Debug.Log("SC public addrss updated : " + sc.playerPublicAddress);

        Debug.Log("public address : "+publicAddress);

        //sc.CallGetTokens(publicAddress);
        //sc.CallGetItems("0x05b3DF12a3092828E727e9E15944Dcca01dCb367");
        //sc.CallGetItems(publicAddress);
